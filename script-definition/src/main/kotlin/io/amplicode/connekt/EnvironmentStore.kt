...
class FileEnvironmentStore(
    ...
    override operator fun <T> getValue(receiver: Any?, property: KProperty<*>): T {
        ...
        val node = values.get(propertyName)
            ?: throw NoEnvironmentPropertyException(envName, propertyName)
        ...
        return when {
            ...
            else -> throw IllegalArgumentException("Unsupported type for property $propertyName")
        }
    }
}
